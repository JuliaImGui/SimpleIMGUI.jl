...
# RadioButton
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_BACKGROUND_NEUTRAL)] = COLORS[Integer(SI.COLOR_INDEX_BACKGROUND)]
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_BACKGROUND_HOT)] = COLORS[Integer(SI.COLOR_INDEX_BACKGROUND)]
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_BACKGROUND_ACTIVE)] = COLORS[Integer(SI.COLOR_INDEX_BACKGROUND)]

COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_BORDER_NEUTRAL)] = COLORS[Integer(SI.COLOR_INDEX_BACKGROUND)]
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_BORDER_HOT)] = COLORS[Integer(SI.COLOR_INDEX_BACKGROUND)]
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_BORDER_ACTIVE)] = COLORS[Integer(SI.COLOR_INDEX_BACKGROUND)]

COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_TEXT_NEUTRAL)] = COLORS[Integer(SI.COLOR_INDEX_TEXT)]
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_TEXT_HOT)] = COLORS[Integer(SI.COLOR_INDEX_TEXT)]
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_TEXT_ACTIVE)] = COLORS[Integer(SI.COLOR_INDEX_TEXT)]

COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_INDICATOR_NEUTRAL)] = COLORS[Integer(SI.COLOR_INDEX_INDICATOR)]
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_INDICATOR_HOT)] = COLORS[Integer(SI.COLOR_INDEX_INDICATOR)]
COLORS[Integer(SI.COLOR_INDEX_RADIO_BUTTON_INDICATOR_ACTIVE)] = COLORS[Integer(SI.COLOR_INDEX_INDICATOR)]
...
COLORS[Integer(SI.COLOR_INDEX_SLIDER_INDICATOR_NEUTRAL)] = COLORS[Integer(SI.COLOR_INDEX_INDICATOR)]
COLORS[Integer(SI.COLOR_INDEX_SLIDER_INDICATOR_HOT)] = COLORS[Integer(SI.COLOR_INDEX_INDICATOR)]
COLORS[Integer(SI.COLOR_INDEX_SLIDER_INDICATOR_ACTIVE)] = COLORS[Integer(SI.COLOR_INDEX_INDICATOR)]
