...
function do_widget!(
        ...
        content_alignment = UP1_LEFT1,
        content_padding = 0,
        background_color_neutral = ui_context.colors[:RADIO_BUTTON_BACKGROUND_NEUTRAL],
        background_color_hot = ui_context.colors[:RADIO_BUTTON_BACKGROUND_HOT],
        background_color_active = ui_context.colors[:RADIO_BUTTON_BACKGROUND_ACTIVE],
        border_color_neutral = ui_context.colors[:RADIO_BUTTON_BORDER_NEUTRAL],
        border_color_hot = ui_context.colors[:RADIO_BUTTON_BORDER_HOT],
        border_color_active = ui_context.colors[:RADIO_BUTTON_BORDER_ACTIVE],
        text_color_neutral = ui_context.colors[:RADIO_BUTTON_TEXT_NEUTRAL],
        text_color_hot = ui_context.colors[:RADIO_BUTTON_TEXT_HOT],
        text_color_active = ui_context.colors[:RADIO_BUTTON_TEXT_ACTIVE],
        indicator_color_neutral = ui_context.colors[:RADIO_BUTTON_INDICATOR_NEUTRAL],
        indicator_color_hot = ui_context.colors[:RADIO_BUTTON_INDICATOR_HOT],
        indicator_color_active = ui_context.colors[:RADIO_BUTTON_INDICATOR_ACTIVE],
    )
...
function do_widget!(
        ...
        background_color_neutral = ui_context.colors[:SLIDER_BACKGROUND_NEUTRAL],
        background_color_hot = ui_context.colors[:SLIDER_BACKGROUND_HOT],
        background_color_active = ui_context.colors[:SLIDER_BACKGROUND_ACTIVE],
        border_color_neutral = ui_context.colors[:SLIDER_BORDER_NEUTRAL],
        border_color_hot = ui_context.colors[:SLIDER_BORDER_HOT],
        border_color_active = ui_context.colors[:SLIDER_BORDER_ACTIVE],
        indicator_color_neutral = ui_context.colors[:SLIDER_INDICATOR_NEUTRAL],
        indicator_color_hot = ui_context.colors[:SLIDER_INDICATOR_HOT],
        indicator_color_active = ui_context.colors[:SLIDER_INDICATOR_ACTIVE],
    )
