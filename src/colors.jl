...
COLORS[Integer(COLOR_NEUTRAL_SLIDER_INDICATOR)] = 0x00909090

COLORS[Integer(COLOR_HOT_SLIDER_BACKGROUND)] = 0x00bfbfbf
COLORS[Integer(COLOR_HOT_SLIDER_BORDER)] = 0x00000000
COLORS[Integer(COLOR_HOT_SLIDER_TEXT)] = 0x00000000
COLORS[Integer(COLOR_HOT_SLIDER_INDICATOR)] = 0x00909090

COLORS[Integer(COLOR_ACTIVE_SLIDER_BACKGROUND)] = 0x00c0c0c0
COLORS[Integer(COLOR_ACTIVE_SLIDER_BORDER)] = 0x00000000
COLORS[Integer(COLOR_ACTIVE_SLIDER_TEXT)] = 0x00000000
COLORS[Integer(COLOR_ACTIVE_SLIDER_INDICATOR)] = 0x00909090
